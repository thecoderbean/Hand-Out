                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4">Let's Empower The World Together</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        ...
                        <h1 class="mb-3">We Provide A Platform For Donating Essentials To The One Who Need It The Most </h1>
                        <p>Handout is the an intiative which helps provide a better way to give out essentaial and useful products to the people who need it the most</p>
                        <div class="row mb-4">
                            <div class="col-6">
                        ...
                        <a href="needs.php" class="btn btn-primary mt-1">view needs</a>
                    </div>
                </div>
            </div>
        </div>
