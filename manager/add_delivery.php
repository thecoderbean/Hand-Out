<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		if (empty(trim($_POST['username']))) {
			...
			$sql = 'SELECT id FROM delivery WHERE username = ?';
	    ...
	    if (empty($username_err) && empty($password_err) && empty($confirm_err)) {
			...
			$sql = 'INSERT INTO delivery (username, password) VALUES (?,?)';
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="approve_reciver.php">Add Delivery</a></li>
	  ...
	  <li><a href="logout.php">Sign Out</a></li>
		...
		<section class="container wrapper">
        	<p class="text-center">Add a new delivery boy to HandOut.</p>
        	<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        		...
        		<div class="form-group">
        			...
        			<input type="reset" class="btn btn-block btn-warning" value="Reset">
        		</div>
        	</form>
		</section>
	</main>
