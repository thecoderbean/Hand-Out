	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      $email = $_POST['email'];
	    ...
	    if (empty($username_err) && empty($password_err) && empty($confirm_err)) {
			...
			$sql = "INSERT INTO receiver (username, address, pin, phone, email, password) VALUES (?,'$address','$pin','$phone','$email',?)";
...
<body>
	<main>
		<section class="container wrapper">
        	...
        	<p class="text-center">Please fill in your credentials and wait for aproval to get products.</p>
        	<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <div class="form-group">
        			...
        			<input type="number" pattern="[789][0-9]{9}" name="phone"  class="form-control">
        			<span class="help-block"></span>
        		</div>
                <div class="form-group">
        			<label for="username">Pin</label>
        			<input type="number" pattern="[0-9]{6}" name="pin"  class="form-control">
        			<span class="help-block"></span>
        		</div>
                <div class="form-group">
