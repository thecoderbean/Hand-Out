...
<body>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-primary"><span class="text-dark">HANDOUT</span> USER</h1>
                </a>
    ...
    <form class="needs-validation" action="donate_action.php" method="POST" enctype="multipart/form-data" novalidate >
  <div class="form-row">
    ...
    <div class="col-md-6 mb-3">
      <label for="validationCustom02">Pickup Adress</label>
	  <textarea name = "pikup_address" class="form-control" placeholder="address of pickup" id="exampleFormControlTextarea1" rows="1" required></textarea>
      <div class="valid-feedback">
        Looks good!
      </div>
	  <div class="invalid-feedback">
        Please provide a pickup destination
      </div>
    </div>
  </div>
  <div class="form-row">
  ...
  <div class="form-group">
    <div class="form-check">
		<input type="hidden" name="comp" value="<?php $comp; ?>">
      <input class="form-check-input" type="checkbox" value="" id="invalidCheck" required>
      <label class="form-check-label" for="invalidCheck">
		<br>
      I hearby agree that im willingly donating this belonging to the charity.
      </label>
      <div class="invalid-feedback">
