...
$thump = $target_file;
$name =$_POST['name'];
$pikup_address = $_POST['pikup_address'];
$email = $_POST['email'];
$discription = $_POST['discription'];
$phone = $_POST['phone'];
$from_id = $_SESSION['id'];
$status ="NOT ASSIGNED";
$sql = "INSERT INTO `donate`(`name`, `description`, `from_id`, `email`, `phone`,`thump`,`status`,`address`) VALUES ('$name','$discription','$from_id','$email','$phone','$thump','$status','$address')";
?>
...
<main class="container wrapper">
        <section>
                ...
                if ($mysql_db->query($sql)) {
                    echo'<h2>'.$name.'</h2>';
                     echo'<p>Has been registered please press back to donate more.</p>';
                    echo'<a class="btn btn-block btn-link bg-light" href="donate.php" role="button">Back</a>';
                    exit;
                }
                ?>
        </section>
